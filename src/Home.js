    ...
    return (
        <section className='full-page-grid'>
            <section className="featured-manga">
                <img className="center-image" src={process.env.PUBLIC_URL + 'public/Solo_leveling.jpg'} alt="Featured Manga" />
            ...
            <img className="center-image" src="Solo_leveling-vol2.jpg" alt="Volume 2" />
            <img className="center-image" src="Solo_leveling-vol3.jpg" alt="Volume 3" />
            <img className="center-image" src="Solo_leveling-vol4.jpg" alt="Volume 4" />
            <img className="center-image" src="Solo_leveling-vol5.jpg" alt="Volume 5" />
            <img className="center-image" src="Solo_leveling-vol6.jpg" alt="Volume 6" />
            <img className="center-image" src="Solo_leveling-vol7.jpg" alt="Volume 7" />
            </section>
        </section>
    );
};
